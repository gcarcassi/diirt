...
public class VTableFactoryTest {
    ...
    public void timeRange1() {
        VTable table = newVTable(column("Timestamp", timeRange(Timestamp.of(0,0), Timestamp.of(6,0))),
                                 column("Value", newVDoubleArray(new ArrayDouble(0.0,2.0,1.0,3.0,4.0,2.0), alarmNone(), timeNow(), displayNone())));
        assertThat(table.getColumnCount(), equalTo(2));
        assertThat(table.getRowCount(), equalTo(6));
        assertThat(table.getColumnName(0), equalTo("Timestamp"));
        assertThat(table.getColumnName(1), equalTo("Value"));
        assertThat(table.getColumnType(0), equalTo((Object) Timestamp.class));
        assertThat(table.getColumnType(1), equalTo((Object) double.class));
        assertThat(table.getColumnData(0), equalTo(Arrays.asList(Timestamp.of(0,0),Timestamp.of(1,200000000),Timestamp.of(2,400000000),Timestamp.of(3,600000000),Timestamp.of(4,800000000),Timestamp.of(6,0))));
        assertThat(table.getColumnData(1), equalTo((Object) new ArrayDouble(0,2,1,3,4,2)));
    }
